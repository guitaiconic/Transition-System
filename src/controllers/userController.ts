...
//   //Check if the encrypted password correspond with the password in database
...
// export const logoutUser = catchAsync(async (req: any, res: any) => {
//   res.cookie("token", "", {
